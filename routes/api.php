...
Route::middleware(['api.key', 'auth:sanctum'])->group(function () {
    ...
    Route::get('/rooms',              [AssetController::class, 'listRooms']);
    Route::post('/admin/assets/{id}/room', [AssetController::class, 'updateRoom']);
    ...
    Route::get('/technician/maintenance',           [TicketController::class, 'maintenanceHistory']);
    Route::get('/technicians',                      [TicketController::class, 'listTechnicians']);
    Route::get('/technicians/leaderboard',          [TicketController::class, 'leaderboard']);
