    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Tambah Ruangan</h2>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <form action="{{ route('rooms.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" required class="block w-full border-gray-300 rounded-md shadow-sm focus-ring-bps" value="{{ old('name') }}" placeholder="Contoh: Ruangan IT">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="3" class="block w-full border-gray-300 rounded-md shadow-sm focus-ring-bps" placeholder="Keterangan ruangan (opsional)">{{ old('description') }}</textarea>
