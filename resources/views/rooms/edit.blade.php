            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-bps-blue to-blue-800 px-6 py-6 sm:px-8 text-white relative">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h2 class="text-xl sm:text-2xl font-bold tracking-tight">Edit Ruangan</h2>
                            <p class="text-blue-100/85 text-xs sm:text-sm mt-0.5">Perbarui data nama ruangan, penanggung jawab, dan rincian lokasinya.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="description" id="description" rows="4"
                                    ...
                                    placeholder="Keterangan singkat mengenai ruangan (opsional)...">{{ old('description', $room->description) }}</textarea>
                            </div>
                            @error('description')
                                <p class="mt-1 text-xs text-red-600 flex items-center gap-1"><i data-lucide="alert-circle" class="w-3 h-3"></i> {{ $message }}</p>
                            @enderror
