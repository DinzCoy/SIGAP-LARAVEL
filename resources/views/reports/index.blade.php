            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-600">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-100 border-b border-gray-200">
                        <tr>
                            <th scope="col" class="px-6 py-4 font-semibold">Status / Hostname</th>
                            <th scope="col" class="px-6 py-4 font-semibold">Ruangan</th>
                            <th scope="col" class="px-6 py-4 font-semibold">IP / MAC</th>
                            <th scope="col" class="px-6 py-4 font-semibold">OS Detail</th>
                            <th scope="col" class="px-6 py-4 font-semibold text-center">RAM Free / Total</th>
                            <th scope="col" class="px-6 py-4 font-semibold text-center">Disk C: Free / Total</th>
                            <th scope="col" class="px-6 py-4 font-semibold">Terakhir Aktif</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-200">
                        ...
                        /* Warning Logic */
                        $ramWarning = $freeRamGb < 2.0; $diskCritical=$freeDiskGb < 10.0; $diskWarning=$freeDiskGb>=
                            10.0 && $freeDiskGb < 25.0; $diskStatusColor=$report->disk_status === 'HEALTHY' ?
                                'text-green-600' : 'text-red-600 font-bold animate-pulse';
                                @endphp
                                ...
                                <tr
                                    ...
                                    <td
                                        class="px-6 py-4 font-medium {{ $report->is_trouble ? 'text-red-700' : 'text-bps-blue' }}">
                                        {{ $report->room_name ?: '-' }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <span class="block text-[10px] text-gray-400 mt-1"
                                            title="Last Windows Patch">Patch: {{ $report->last_patch }}</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($report->last_seen)
                                            ...
                                            <span
                                                class="text-xs {{ $isOffline ? 'text-red-500 font-medium' : 'text-gray-500' }}">
